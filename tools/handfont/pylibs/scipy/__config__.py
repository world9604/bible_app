...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": r"0.18.1",
                "include directory": r"../../tmp/build-env-9ogizriy/lib/python3.14/site-packages/pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Build Dependencies": {
            "blas": {
                ...
                "openblas configuration": r"OpenBLAS 0.3.30 DYNAMIC_ARCH NO_AFFINITY Haswell MAX_THREADS=64",
        ...
        "Python Information": {
            "path": r"/tmp/build-env-9ogizriy/bin/python",
            "version": "3.14",
        },
    }
)
