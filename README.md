...
## 데이터
MVP는 인메모리 샘플 데이터(공개 도메인 일부 의역). 정식 출시 전 라이선스 가능한 한국어 역본으로 교체 예정. 데이터 구조는 `composeApp/src/commonMain/kotlin/com/wordcard/app/data/source/SampleBibleDataSource.kt` 참고.
